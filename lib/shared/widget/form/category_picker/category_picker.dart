...
enum QCategoryPickerStyle { defaultStyle, boldStyle, fittedStyle, fittedStyle2 }
...
class QCategoryPicker extends StatefulWidget {
  ...
  final Function(Map<String, dynamic> item, bool selected, Function action)?
  itemBuilder;
...
class _QCategoryPickerState extends State<QCategoryPicker> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      margin: EdgeInsets.only(bottom: widget.label == null ? 0 : 12.0),
      child: LayoutBuilder(
                      ...
                      SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: List.generate(items.length, (index) {
                            ...
                            if (widget.style ==
                                QCategoryPickerStyle.boldStyle) {
                              return Container(
                                height: 32,
