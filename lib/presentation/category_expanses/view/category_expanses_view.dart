...
class CategoryExpansesView extends StatelessWidget {
  const CategoryExpansesView({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(CategoryExpansesController());
  ...
  Widget _buildCategoryList(CategoryExpansesController controller) {
